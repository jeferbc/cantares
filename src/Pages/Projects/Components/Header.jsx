...
import "../../../Componant1/Banner/banner.css";
import "swiper/css/pagination";
import ContactUs from "../../../Shared/ContactUs";
import PropTypes from "prop-types";

const ProjectHeader = ({img, text1, text2, text3 }) => {
  const settings = {
    loop: true,
    speed: 2000,
    autoplay: {
  ...
  return (
    <div className="relative" id="header">
      <Swiper {...settings}>
        <SwiperSlide>
          <section className={`bg-[url('${img}')] bg-cover bg-left lg:bg-center bg-no-repeat h-[750px] sm:h-[700px] md:h-[750px] lg:h-[760px] xl:h-[960px] flex items-center`}>
